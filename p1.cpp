...
void drawArm(GLfloat uArmAngle, GLfloat lArmAngle, GLfloat pawAngle) {
	...
	// upper arm
	glRotatef(UBODY_UARM_ANGLE,0,0,1);
	...
	glRotatef(UARM_LARM_ANGLE,0,0,1);
	...
	glRotatef(LARM_PAW_ANGLE,0,0,1);
...
void drawLeg(GLfloat uLegAngle, GLfloat lLegAngle, GLfloat pawAngle) {
	...
	// upper leg
	glRotatef(MBODY_ULEG_ANGLE,0,0,1);
	...
	glRotatef(ULEG_LLEG_ANGLE,0,0,1);
	...
	// leg paw
	glTranslatef(L_LEG_LENGTH/2,0,0);
	glRotatef(LLEG_PAW_ANGLE,0,0,1);
...
void drawRabbit() {
	...
	glPopMatrix();
	glTranslatef(M_BODY_LENGTH/2,M_BODY_WIDTH/2,0);
	glRotatef(MBODY_UBODY_ANGLE,0,0,1);
	...
	glRotatef(HEAD_NECK_ANGLE,0,0,1);
	...
	glRotatef(UBODY_HEAD_ANGLE,0,0,1);
